const userData = {
    orgName: "Nome Comprador", // Mantemos apenas este campo para o nome
...
function updateUI() {
    ...
    document.getElementById("cidade").textContent = userData.cidade;
...
function saveChanges() {
    ...
    userData.estado = document.getElementById("edit-estado").value;
    userData.cidade = document.getElementById("edit-cidade").value;
